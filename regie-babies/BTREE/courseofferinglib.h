...
void search_co_courseid(int key);
void search_co_maxstud(int key);
void search_co_semester(enum Semester semester);
void search_co_acadyear(char *key);
void search_co_time(char *key);
void search_co_courseno(char *key);
void search_co_section(char *key);
